...
You can check and change situation of your tasks wherever you are if only you access this "My Stickies"!
...
When you want to add a new task, you only create new "Stickies" on the board applying the task's situation.<br>
...
作成したタスクの状況が変わった時(例えばTodoからDoingに変わった時）は、対象タスクのStickies（付箋）をドラッグアンドドロップすれば、タスクの状況を変更することができます。<br>
